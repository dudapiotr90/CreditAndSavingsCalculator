...
import pl.zajavka.bankCalculator.calculators.creditCalculator.modelOfCredit.RateTypes;
...
import pl.zajavka.bankCalculator.calculators.savingsCalculator.modelOfSavings.SavingsType;
...
public class InputDataRepository {
    ...
    public Optional<MortgageData> readMortgageDataFile() {
        ...
        return Optional.ofNullable(MortgageData.builder()
