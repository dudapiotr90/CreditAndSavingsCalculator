...
public interface PrintingService {
    ...
    void printIntroInformation(MortgageData mortgageData);

    void printRatesSchedule(List<Rate> rates, MortgageData mortgageData);
    ...
    void printSavingsInformation(SavingsData savingsData, MortgageData mortgageData);
    ...
    void printComparison(Comparison comparison, MortgageData mortgageData);
}
